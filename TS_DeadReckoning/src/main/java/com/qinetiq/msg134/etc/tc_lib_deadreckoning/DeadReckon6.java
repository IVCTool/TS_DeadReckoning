...
/**
 * Implementation of dead reckoning algorithm 6
 *
 * @author rjjones3
 * @since 10/08/2016
 */
public class DeadReckon6 extends AbstractDeadReckon
{
    /**
     ...
     *            The logger to use
     */
    public DeadReckon6(final Logger logger)
    {
        super(logger);
    }
    ...
    {
        logger.warn("Algorithm 6 does not provide Orientation calculation.");
