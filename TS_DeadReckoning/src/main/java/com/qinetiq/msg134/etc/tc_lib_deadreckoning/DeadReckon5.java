...
/**
 * Implementation of dead reckoning algorithm 5
 *
 * @author rjjones3
 * @since 10/08/2016
 */
public class DeadReckon5 extends DeadReckon4
{
     ...
     *            The logger to use
     */
    public DeadReckon5(final Logger logger)
    {
        super(logger);
    }
    ...
    {
        super.deadReckon(pZero, vZero, aZero, 
    ...
    {
        logger.warn("Algorithm 5 does not provide Orientation calculation.");
