...
/**
 * Implementation of dead reckoning algorithm 8
 *
 * @author rjjones3
 * @since 10/08/2016
 */
public class DeadReckon8 extends AbstractDeadReckon
{
    /**
     ...
     *            The logger to use
     */
    public DeadReckon8(final Logger logger)
    {
        super(logger);
    }
    ...
    public double[] getOrientation()
    {
        ...
        {
            if (newEulerAngles.getNumElements() != 3)
            {
