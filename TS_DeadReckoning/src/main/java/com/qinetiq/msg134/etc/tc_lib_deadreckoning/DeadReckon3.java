...
/**
 * Implementation of dead reckoning algorithm 3
 *
 * @author rjjones3
 * @since 10/08/2016
 */
public class DeadReckon3 extends DeadReckon4
{
    /**
     ...
     *            The logger to use
     */
    public DeadReckon3(Logger logger)
    {
        super(logger);
    }
    ...
    {
        super.deadReckon(pZero, vZero, DeadReckonCommon.nullVector(), // This algorithm does not use acceleration
                eulerAngles, bodyAxisVelocity, deltaT);
    }
